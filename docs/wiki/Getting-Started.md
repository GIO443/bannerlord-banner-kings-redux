...
> Each BK estate is woven onto one of **Bannerlord Living Economy's**
> estate parcels — the estate's land type, size, and quality come from the
> bound parcel. Living Economy is a required dependency; see
